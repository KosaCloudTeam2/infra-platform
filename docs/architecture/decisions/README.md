...
| ADR-005 | [GitHub Actions OIDC 기반 배포](./ADR-005-github-actions-oidc.md)                                 | Accepted   | 2026-05-03 | 장기 AWS Access Key 없이 GitHub Actions가 AWS fallback 배포 권한을 임시로 획득                    |
...
| ADR-009 | [Docker Hub 기반 MVP 이미지 저장소](./ADR-009-docker-hub-registry-mvp.md)                         | Accepted   | 2026-05-06 | 비용 부담을 줄이기 위해 Docker Hub를 기본 이미지 저장소로 두고 Private Registry는 확장안으로 분리 |
