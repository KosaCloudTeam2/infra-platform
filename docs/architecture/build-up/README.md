...
| 03   | CI/CD / App Runtime                | [03_cicd_app_runtime.md](./03_cicd_app_runtime.md)           | [03_cicd_app_runtime_implementation.md](./03_cicd_app_runtime_implementation.md)           | GitHub Actions, ECR, Argo CD, K8s manifest, 앱-DB 연결         |
