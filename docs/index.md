...
| 3    | [Team Decision Checklist](./21_team_decision_checklist.md) | 팀 회의에서 결정해야 할 선택지와 용어 확인 |
| 4    | [Schedule 13+3](./02_schedule_13_plus_3.md)                | 13일 구축 + 3일 발표 일정 확인             |
| 5    | [Roles and Work Packages](./03_roles_and_work_packages.md) | 팀원별 책임과 작업 패키지 확인             |
| 6    | [Implementation Scope](./04_implementation_scope.md)       | MVP와 선택 확장 범위 확인                  |
| 7    | [Security Policy](./05_security_policy.md)                 | OIDC, SG, WAF, Secret 기준 확인            |
| 8    | [Demo Presentation Plan](./06_demo_presentation_plan.md)   | 발표/시연 흐름 확인                        |
| 9    | [Definition of Done](./07_definition_of_done.md)           | 완료 기준 확인                             |
| 10   | [Risk Register](./08_risk_register.md)                     | 주요 리스크와 대응 확인                    |
| 11   | [Cleanup Plan](./09_cleanup_plan.md)                       | 발표 후 비용 정리 계획 확인                |
...
| [Team Decision Checklist](./21_team_decision_checklist.md)         | 팀 회의에서 선택해야 할 하이브리드 구조, EKS/ECS/S3/Ceph 결정 항목 |
...
| 담당                    | 핵심 문서                                                                                                                                                               |
| :---------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Network / IaC           | [01 Network / IaC](./architecture/build-up/01_network_iac.md), [Implementation](./architecture/build-up/01_network_iac_implementation.md)                               |
...
| Observability / Demo    | [04 Observability / Demo](./architecture/build-up/04_observability_demo.md), [Implementation](./architecture/build-up/04_observability_demo_implementation.md)          |
...
| Runbook                                                | 목적                          |
| :----------------------------------------------------- | :---------------------------- |
| [Deployment](./runbooks/deployment.md)                 | ECS 배포 확인                 |
| [Rollback](./runbooks/rollback.md)                     | 배포 실패/서비스 장애 롤백    |
| [Monitoring](./runbooks/monitoring.md)                 | CloudWatch 기반 관측          |
...
때문임. MkDocs를 도입할 때도 파일을 대규모 이동하기보다 `mkdocs.yml`의 `nav`로 위 읽기 순서를
표현하는 방식을 우선함.
