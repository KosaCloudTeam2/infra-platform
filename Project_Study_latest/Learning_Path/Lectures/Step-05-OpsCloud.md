...
- Prometheus/Grafana 기반 통합 모니터링 체계 이해
- HA 기능 검증 및 장애 대응 룬북 습득
- AWS 하이브리드 VPN 구성 및 라우팅 원리 파악

## 2. 관측성 아키텍처 (Prometheus Pull 모델)
...
> AWS VPN 연동 시 온프레 pfSense에는 AWS 대역(`10.20.0.0/16`) 대상 Outbound NAT Bypass 룰이 필요함.

## 4. 장애 대응 검증 리스트 (Validation)
