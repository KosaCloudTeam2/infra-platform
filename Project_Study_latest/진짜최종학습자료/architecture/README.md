...
| 07 | `07-bootstrap-resilience.md` | ⭐ K8s 의존성 + CI/CD 분리 (Bootstrap 문제) | ~8p |
| 08 | `08-onprem-autoscaling.md` | ⭐ 온프레 워커 자동 프로비저닝 (Terraform + Ansible) | ~10p |
...
8. **⚠️ 모든 게 K8s에 있는데 K8s 죽으면 어떻게? (CI/CD bootstrap 문제)**
   → 07 — 솔직한 약점 + Phase 6 해결책

9. **⚠️ 워커 자원 부족시 AWS는 Karpenter인데 온프레는?**
   → 08 — Terraform/Ansible 자동화 계획
